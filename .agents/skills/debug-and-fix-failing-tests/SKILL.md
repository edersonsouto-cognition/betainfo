...
3. Decide: is the product code wrong or the test outdated? Fix the product code by default. If the failure is in `TaskService`, check whether a known bug was reintroduced or whether a new edge case is uncovered.
